...
class UserAnnouncementActivity : AppCompatActivity() {
    ...
    private fun loadUserAnnouncements() {
        ...
        firestore.collection("usersAnnpuncements")
            ...
            .addSnapshotListener { snapshots, error ->
                if (error != null) {
                    Toast.makeText(this, "Duyurular alınamadı: ${error.message}", Toast.LENGTH_SHORT).show()
    ...
    private fun fetchAnnouncements() {
        firebaseFirestoreHelper.getUserAnnouncements(
            ...
            onFailure = { error ->
                Toast.makeText(this, "Kullanıcı duyuruları alınamadı: $error", Toast.LENGTH_SHORT).show()
            }
        )
